...
async function main() {
    ...
    try {
        ...
        renderer.RenderQueue.push(new Renderable(renderer, new Float32Array([0, 0.5, -0.5, -0.5, 0.5, -0.5]), [1, 0, 0, 1], "triangle-list"));
        renderer.RenderQueue.push(new Renderable(renderer, new Float32Array([0, 0.4, -0.4, -0.4, 0.4, -0.4]), [0, 1, 0, 1], "triangle-list"));
        renderer.RenderQueue.push(new Renderable(renderer, new Float32Array([0, 0.3, -0.3, -0.3, 0.3, -0.3]), [0, 1, 1, 1], "triangle-list"));
    } catch (err) {
